...
$(document).ready( function() {
  ...
  $('.navbar-nav > li > ul > li > a, #stop-monitoring-main').on('click', function(e) {
    e.preventDefault();
  ...
  $('#stop-monitoring-trigger, #stop-monitoring-main').on('click', function(e) {
    e.preventDefault();
  ...
  $('.pannel-trigger').on('click', function(e) {
