...
stopMonitoringRequest = (function() {
  ...
  stopMonitoringRequest.prototype.startDate = function() {
    var hours, minutes, offset, requestDate, _ref;
    if (this.start) {
      requestDate = new Date;
      _ref = this.start.split(':'), hours = _ref[0], minutes = _ref[1];
  ...
  stopMonitoringRequest.prototype.parseForm = function(el) {
    var form, input, key, parseVariables, _i, _len, _results;
    ...
    _results = [];
    for (_i = 0, _len = parseVariables.length; _i < _len; _i++) {
      key = parseVariables[_i];
      input = form.find('#' + key);
      _results.push(this[key] = input.val());
    }
    return _results;
  };
  ...
  stopMonitoringRequest.prototype.handleStopMonitoringResponse = function(xmlResponse, handler) {
    var node, nodes, siriVersionToDisplay, _i, _len;
  ...
  stopMonitoringRequest.prototype.handleGeneralMessageResponse = function(xmlResponse, handler) {
    var errorSpan, node, nodes, _i, _len;
