...
stopMonitoringRequest = (function() {
  ...
  stopMonitoringRequest.prototype.parseForm = function(el) {
    ...
    parseVariables = ["stopId", "lineId", "destId", "operatorId", "start", "preview", "typeVisit", "maxStop", "minStLine", "onward", "requestorVersion", "requestorName", "destinationRef", "groupOfLinesRef", "perturbationType"];
    form = $(el);
